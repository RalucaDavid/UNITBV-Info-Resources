...
void InitD3D(HWND hWnd)
{
    ...
    // Calculate 10% of the window
    int deltaHeight = (windowRect.bottom - windowRect.top) * 0.1;
    int deltaWidth = (windowRect.right - windowRect.left) * 0.1;
    VOID* pVoid;    // the void pointer
    pVertexBuffer->Lock(0, 0, (void**)&pVoid, 0);    // lock the vertex buffer
    CUSTOMVERTEX pTriangleVertices[] =
    {
        { (windowRect.right - windowRect.left) / 2.0f,  deltaHeight, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255),},
        { windowRect.right - deltaWidth, windowRect.bottom - deltaHeight, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 0),},
        { deltaWidth, windowRect.bottom - deltaHeight, 1.0f, 1.0f, D3DCOLOR_XRGB(255, 0, 0),},
    };
...
void RenderFrame(void)
{
    ...
    d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(0,70,0), 1.0f, 0);
