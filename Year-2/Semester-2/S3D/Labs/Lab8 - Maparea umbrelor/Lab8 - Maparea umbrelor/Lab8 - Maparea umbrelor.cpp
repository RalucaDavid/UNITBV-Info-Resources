...
void renderScene(const Shader& shader)
{
	...
	// cube
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(2.5f, 1.75f, 0.0));
	...
	model = glm::rotate(model, 0.5f, glm::vec3(1, 1, 0));
	shader.SetMat4("model", model);
	renderCube();

	model = glm::mat4();
	model = glm::translate(model, glm::vec3(0.9f, 2.0f, 0.0));
	model = glm::scale(model, glm::vec3(0.4f));
	model = glm::rotate(model, 0.25f, glm::vec3(1, 0, 1));
	shader.SetMat4("model", model);
	renderCube();

	model = glm::mat4();
	model = glm::translate(model, glm::vec3(-2.0f, 1.8f, 0.0));
	model = glm::scale(model, glm::vec3(0.8f));
	model = glm::rotate(model, 0.75f, glm::vec3(1, 0, 1));
	shader.SetMat4("model", model);
	renderCube();
}
